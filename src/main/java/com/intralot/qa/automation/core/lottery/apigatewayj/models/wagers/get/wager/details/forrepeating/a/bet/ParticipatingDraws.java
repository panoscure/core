...
public class ParticipatingDraws {
    ...
    @Expose
    private List<DatePattern> datePattern = null;
    @SerializedName("dayPattern")
    @Expose
    private List<DayPattern> dayPattern = null;
    ...
    public List<DatePattern> getDatePattern() {
        return datePattern;
    }

    public void setDatePattern(List<DatePattern> datePattern) {
        this.datePattern = datePattern;
    }

    public List<DayPattern> getDayPattern() {
        return dayPattern;
    }

    public void setDayPattern(List<DayPattern> dayPattern) {
