...
public class PAMWallets {
    ...
    public static Object getPlayersWallet(Map<String, String> headers, String sessionToken) {
        headers.put("Guid", UUID.randomUUID().toString());
        headers.put("sessionToken", sessionToken);
        return given()
                .headers(headers)
                .filters(new RequestLoggingFilter(), new ResponseLoggingFilter())
                .get(CustomProperties.getPropertyValue("apigatewayj") + "/api/v1.0/wallets/balance");
    }
