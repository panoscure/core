...
public class Authentication {
    ...
    public static String grantAuthorizationTokenExtractToken(String agj_url, Map<String, String> headers, Map<String, String> formData) {
        return given()
                .headers(headers)
                .formParams(formData)
                .when()
                .filters(new RequestLoggingFilter(), new ResponseLoggingFilter())
                .post(agj_url + "/authentication/token")
                .then()
                .statusCode(HTTP_OK)
