...
public class MyBetsModel {
    ...
    @Expose
    private CashoutResult cashoutResult;
    @SerializedName("parlayBet")
    @Expose
    private Boolean parlayBet;
    @SerializedName("parlayCard")
    @Expose
    private String parlayCard;
    @SerializedName("name")
    @Expose
    private Object name;
    ...
    public CashoutResult getCashoutResult() {
        return cashoutResult;
    }

    public void setCashoutResult(CashoutResult cashoutResult) {
        this.cashoutResult = cashoutResult;
    }

    public Boolean getParlayBet() {
        return parlayBet;
    }

    public void setParlayBet(Boolean parlayBet) {
        this.parlayBet = parlayBet;
    }

    public String getParlayCard() {
        return parlayCard;
    }

    public void setParlayCard(String parlayCard) {
