...
import com.intralot.qa.automation.core.device.information.model.*;
import com.intralot.qa.automation.core.device.information.model.*;
...
public class AllDeviceFinder implements DeviceFinder<Device> {
    ...
    public DeviceInfoModel<Device> findDevices(String localPath) throws IOException {
        ...
        if (deviceAndroid != null) devices.addAll(deviceAndroid);
        if (deviceIos != null) devices.addAll(deviceIos);
        if (deviceIosSimulator != null) devices.addAll(deviceIosSimulator);
